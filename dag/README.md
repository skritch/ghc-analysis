...
You can start writing assets in `ghc/assets.py`. The assets are automatically loaded into the Dagster code location as you define them.
...
Tests are in the `ghc_tests` directory and you can run tests using `pytest`:
